...
## 📊 Results & Evaluation
The model's performance is thoroughly evaluated using metrics such as Precision, Recall, and F1-Score on the test set. A Confusion Matrix is used to analyze class-wise accuracy and identify common misclassifications.
